...
class Ready extends BaseEvent {
    ...
    async run(interaction) {
        ...
        if (interaction.isCommand()) {
            ...
            if (command.required.owner && context.author.id !== context.guild.ownerId) return context.err("You need to be the Server Owner to use this command for security reasons!");
            command.run(context);
        }
    }
}
